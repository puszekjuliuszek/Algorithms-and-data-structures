#Juliusz Wasieleski
#Robię sobie mst od każdej krawędzi i szukam takiego, gdzie różnica międy najdłuższą a najkrótszą krawędzią jest najmniejsza
...
def restore_vertex(vertex):
    for k in vertex:
        k.parent = k
        k.rank = 0

def correct_minn(cnt,minn, edges,j,i,n):
    if cnt >= n - 1:
